...
def execute_order(
    ...
    try:
        ...
        current_user.balance = models.User.balance + total_cost if transaction.transaction_type == "sell" else models.User.balance - total_cost
        current_user.balance = func.round(current_user.balance, 3)
        ...
        return {
            "status": "success",
            "executed_price": float(new_trxn.price),
